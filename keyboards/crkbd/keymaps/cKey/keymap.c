...
const uint16_t PROGMEM combo_close_normal_bracket[] = {CK____V, CK____W, COMBO_END};
const uint16_t PROGMEM combo_open_curly_bracket[] = {CK____T, CK____U, CK____V, COMBO_END};
const uint16_t PROGMEM combo_close_curly_bracket[] = {CK____U, CK____V, CK____W, COMBO_END};
const uint16_t PROGMEM combo_open_rectangular_bracket[] = {CK____H, CK____I, COMBO_END};
const uint16_t PROGMEM combo_close_rectangular_bracket[] = {CK____J, CK____K, COMBO_END};
...
const uint16_t PROGMEM combo_alt_tab[] = {CK____B, CK____C, COMBO_END};
...
combo_t key_combos[] = {
    ...
    [CM_ALTB] = COMBO(combo_alt_tab, KC_NO), // KC_NO to leave processing for process_combo_event
};
